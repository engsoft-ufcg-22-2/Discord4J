...
class ChatInputInteractionEventTest {
    /**
     * Method under test: {@link ChatInputInteractionEvent#ChatInputInteractionEvent(GatewayDiscordClient, ShardInfo, Interaction)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new ChatInputInteractionEvent(gateway, shardInfo, new Interaction(new GatewayDiscordClient(null, gatewayResources2,
    ...
    void testConstructor2() {
        ...
        VoiceConnectionFactory voiceConnectionFactory2 = mock(VoiceConnectionFactory.class);
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        new ChatInputInteractionEvent(gateway, shardInfo,
    ...
    /**
     * Method under test: {@link ChatInputInteractionEvent#getOption(String)}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOption() {
    ...
    /**
     * Method under test: {@link ChatInputInteractionEvent#getOptions()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOptions() {
