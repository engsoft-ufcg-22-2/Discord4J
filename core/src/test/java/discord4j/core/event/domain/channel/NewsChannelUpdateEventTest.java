...
class NewsChannelUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link NewsChannelUpdateEvent#NewsChannelUpdateEvent(GatewayDiscordClient, ShardInfo, GuildMessageChannel, NewsChannel)}
     *   <li>{@link NewsChannelUpdateEvent#getCurrent()}
     *   <li>{@link NewsChannelUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.channel.NewsChannelUpdateEvent.<init>.
        ...
        GuildMessageChannel current = null;
        NewsChannel old = null;

        // Act
        NewsChannelUpdateEvent actualNewsChannelUpdateEvent = new NewsChannelUpdateEvent(gateway, shardInfo, current, old);
        GuildMessageChannel actualCurrent = actualNewsChannelUpdateEvent.getCurrent();
        String actualToStringResult = actualNewsChannelUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link NewsChannelUpdateEvent#getNewsChannel()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetNewsChannel() {
        ...
        NewsChannel current = new NewsChannel(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
        ...
        (new NewsChannelUpdateEvent(gateway, shardInfo, current,
            new NewsChannel(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
                voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null))).getNewsChannel();
    }

    /**
     * Method under test: {@link NewsChannelUpdateEvent#getTextChannel()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetTextChannel() {
        ...
        (new NewsChannelUpdateEvent(gateway, shardInfo, current,
            new NewsChannel(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
                voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null))).getTextChannel();
    }

    /**
     * Method under test: {@link NewsChannelUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
