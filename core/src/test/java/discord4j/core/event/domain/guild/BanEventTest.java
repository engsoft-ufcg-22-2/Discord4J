...
class BanEventTest {
     ...
     *
     * <ul>
     *   <li>{@link BanEvent#BanEvent(GatewayDiscordClient, ShardInfo, User, long)}
     *   <li>{@link BanEvent#getUser()}
     *   <li>{@link BanEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.guild.BanEvent.<init>.
        ...
        // Act
        BanEvent actualBanEvent = new BanEvent(gateway, shardInfo, user, guildId);
        User actualUser = actualBanEvent.getUser();
        String actualToStringResult = actualBanEvent.toString();
    ...
    /**
     * Method under test: {@link BanEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
        ...
        (new BanEvent(gateway, shardInfo, new User(new GatewayDiscordClient(null, gatewayResources2, null,
    ...
    /**
     * Method under test: {@link BanEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
