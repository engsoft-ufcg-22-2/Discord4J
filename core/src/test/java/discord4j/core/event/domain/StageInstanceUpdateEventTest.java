...
class StageInstanceUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link StageInstanceUpdateEvent#StageInstanceUpdateEvent(GatewayDiscordClient, ShardInfo, StageInstance, StageInstance)}
     *   <li>{@link StageInstanceUpdateEvent#getCurrent()}
     *   <li>{@link StageInstanceUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.StageInstanceUpdateEvent.<init>.
        ...
        StageInstance old = null;

        // Act
        StageInstanceUpdateEvent actualStageInstanceUpdateEvent = new StageInstanceUpdateEvent(gateway, shardInfo, current,
            old);
        StageInstance actualCurrent = actualStageInstanceUpdateEvent.getCurrent();
        String actualToStringResult = actualStageInstanceUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link StageInstanceUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        StageInstance current = new StageInstance(new GatewayDiscordClient(null, gatewayResources2, null,
        ...
        (new StageInstanceUpdateEvent(gateway, shardInfo, current,
            new StageInstance(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
