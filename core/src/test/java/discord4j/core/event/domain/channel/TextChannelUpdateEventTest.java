...
class TextChannelUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link TextChannelUpdateEvent#TextChannelUpdateEvent(GatewayDiscordClient, ShardInfo, GuildMessageChannel, TextChannel)}
     *   <li>{@link TextChannelUpdateEvent#getCurrent()}
     *   <li>{@link TextChannelUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.channel.TextChannelUpdateEvent.<init>.
        ...
        TextChannel old = null;

        // Act
        TextChannelUpdateEvent actualTextChannelUpdateEvent = new TextChannelUpdateEvent(gateway, shardInfo, current, old);
        GuildMessageChannel actualCurrent = actualTextChannelUpdateEvent.getCurrent();
        String actualToStringResult = actualTextChannelUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link TextChannelUpdateEvent#getNewsChannel()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetNewsChannel() {
        ...
        (new TextChannelUpdateEvent(gateway, shardInfo, current,
            new TextChannel(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
                voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null))).getNewsChannel();
    }

    /**
     * Method under test: {@link TextChannelUpdateEvent#getTextChannel()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    ...
    /**
     * Method under test: {@link TextChannelUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
