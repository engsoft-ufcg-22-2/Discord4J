...
class ConnectEventTest {
     ...
     *
     * <ul>
     *   <li>{@link ConnectEvent#ConnectEvent(GatewayDiscordClient, ShardInfo)}
     *   <li>{@link ConnectEvent#toString()}
     * </ul>
     */
    @Test
    void testConstructor() {
        ...
        assertEquals("Gateway connection established",
                (new ConnectEvent(new GatewayDiscordClient(null, gatewayResources, null, null, voiceConnectionFactory,
