...
class RoleCreateEventTest {
    /**
     * Method under test: {@link RoleCreateEvent#RoleCreateEvent(GatewayDiscordClient, ShardInfo, long, Role)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new RoleCreateEvent(gateway, shardInfo, 1L, new Role(new GatewayDiscordClient(null, gatewayResources2, null,
    ...
    /**
     * Method under test: {@link RoleCreateEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
    ...
    /**
     * Method under test: {@link RoleCreateEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
     ...
     *
     * <ul>
     *   <li>{@link RoleCreateEvent#getRole()}
     *   <li>{@link RoleCreateEvent#toString()}
     * </ul>
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetRole() {
        ...
        //   discord4j.core.event.domain.role.RoleCreateEvent.<init>.
        ...
        RoleCreateEvent roleCreateEvent = null;

        // Act
        Role actualRole = roleCreateEvent.getRole();
        String actualToStringResult = roleCreateEvent.toString();
