...
class MemberJoinEventTest {
     ...
     *
     * <ul>
     *   <li>{@link MemberJoinEvent#MemberJoinEvent(GatewayDiscordClient, ShardInfo, Member, long)}
     *   <li>{@link MemberJoinEvent#getMember()}
     *   <li>{@link MemberJoinEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.guild.MemberJoinEvent.<init>.
        ...
        // Act
        MemberJoinEvent actualMemberJoinEvent = new MemberJoinEvent(gateway, shardInfo, member, guildId);
        Member actualMember = actualMemberJoinEvent.getMember();
        String actualToStringResult = actualMemberJoinEvent.toString();
    ...
    /**
     * Method under test: {@link MemberJoinEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
        ...
        (new MemberJoinEvent(gateway, shardInfo, new Member(new GatewayDiscordClient(null, gatewayResources2, null,
            gatewayClientGroup2, voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L), 1L))
            .getGuildId();
    }
    ...
    /**
     * Method under test: {@link MemberJoinEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
