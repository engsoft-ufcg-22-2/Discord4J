...
class UserUpdateEventTest {
     ...
     *
     * <ul>
     *   <li>{@link UserUpdateEvent#UserUpdateEvent(GatewayDiscordClient, ShardInfo, User, User)}
     *   <li>{@link UserUpdateEvent#getCurrent()}
     *   <li>{@link UserUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.UserUpdateEvent.<init>.
        ...
        // Act
        UserUpdateEvent actualUserUpdateEvent = new UserUpdateEvent(gateway, shardInfo, current, old);
        User actualCurrent = actualUserUpdateEvent.getCurrent();
        String actualToStringResult = actualUserUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link UserUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        User current = new User(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
        ...
        (new UserUpdateEvent(gateway, shardInfo, current, new User(new GatewayDiscordClient(null, gatewayResources3, null,
            gatewayClientGroup3, voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null))).getOld();
    }
