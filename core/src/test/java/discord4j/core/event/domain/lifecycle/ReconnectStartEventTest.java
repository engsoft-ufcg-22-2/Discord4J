...
class ReconnectStartEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link ReconnectStartEvent#ReconnectStartEvent(GatewayDiscordClient, ShardInfo)}
     *   <li>{@link ReconnectStartEvent#toString()}
     * </ul>
     */
    @Test
    void testConstructor() {
        ...
        assertEquals("Gateway reconnect attempt started",
                (new ReconnectStartEvent(new GatewayDiscordClient(null, gatewayResources, null, null, voiceConnectionFactory,
                        entityRetrievalStrategy, new HashSet<>()), mock(ShardInfo.class))).toString());
    }
}
