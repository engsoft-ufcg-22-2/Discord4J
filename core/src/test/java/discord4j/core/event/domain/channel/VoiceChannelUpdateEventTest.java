...
class VoiceChannelUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link VoiceChannelUpdateEvent#VoiceChannelUpdateEvent(GatewayDiscordClient, ShardInfo, VoiceChannel, VoiceChannel)}
     *   <li>{@link VoiceChannelUpdateEvent#getCurrent()}
     *   <li>{@link VoiceChannelUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.channel.VoiceChannelUpdateEvent.<init>.
        ...
        // Act
        VoiceChannelUpdateEvent actualVoiceChannelUpdateEvent = new VoiceChannelUpdateEvent(gateway, shardInfo, current,
            old);
        VoiceChannel actualCurrent = actualVoiceChannelUpdateEvent.getCurrent();
        String actualToStringResult = actualVoiceChannelUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link VoiceChannelUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        VoiceChannel current = new VoiceChannel(new GatewayDiscordClient(null, gatewayResources2, null,
        ...
        (new VoiceChannelUpdateEvent(gateway, shardInfo, current,
            new VoiceChannel(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
