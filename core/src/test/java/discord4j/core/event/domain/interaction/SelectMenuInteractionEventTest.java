...
class SelectMenuInteractionEventTest {
    /**
     * Method under test: {@link SelectMenuInteractionEvent#SelectMenuInteractionEvent(GatewayDiscordClient, ShardInfo, Interaction)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new SelectMenuInteractionEvent(gateway, shardInfo, new Interaction(new GatewayDiscordClient(null, gatewayResources2,
    ...
    void testConstructor2() {
        ...
        VoiceConnectionFactory voiceConnectionFactory2 = mock(VoiceConnectionFactory.class);
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        new SelectMenuInteractionEvent(gateway, shardInfo,
    ...
    /**
     * Method under test: {@link SelectMenuInteractionEvent#getValues()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetValues() {
        ...
        (new SelectMenuInteractionEvent(gateway, shardInfo,
            new Interaction(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null))).getValues();
    }
