...
class ThreadChannelUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link ThreadChannelUpdateEvent#ThreadChannelUpdateEvent(GatewayDiscordClient, ShardInfo, ThreadChannel, ThreadChannel)}
     *   <li>{@link ThreadChannelUpdateEvent#getChannel()}
     *   <li>{@link ThreadChannelUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.thread.ThreadChannelUpdateEvent.<init>.
        ...
        ThreadChannel old = null;

        // Act
        ThreadChannelUpdateEvent actualThreadChannelUpdateEvent = new ThreadChannelUpdateEvent(gateway, shardInfo, channel,
            old);
        ThreadChannel actualChannel = actualThreadChannelUpdateEvent.getChannel();
        String actualToStringResult = actualThreadChannelUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link ThreadChannelUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        ThreadChannel channel = new ThreadChannel(new GatewayDiscordClient(null, gatewayResources2, null,
        ...
        (new ThreadChannelUpdateEvent(gateway, shardInfo, channel,
            new ThreadChannel(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
