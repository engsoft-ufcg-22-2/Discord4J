...
class PresenceUpdateEventTest {
    /**
     * Method under test: {@link PresenceUpdateEvent#PresenceUpdateEvent(GatewayDiscordClient, ShardInfo, long, User, PartialUserData, Presence, Presence)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        User oldUser = new User(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
            voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null);

        Presence current = new Presence(null);
        new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null));
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getGuildId();
    }
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getGuild();
    }
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getOldUser()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOldUser() {
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getOldUser();
    }
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getNewUsername()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetNewUsername() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getNewUsername();
    }
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getNewDiscriminator()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetNewDiscriminator() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getNewAvatar()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetNewAvatar() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getNewAvatar();
    }
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getUserId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetUserId() {
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getUserId();
    }
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getUser()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetUser() {
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getUser();
    }
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getMember()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetMember() {
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getMember();
    }
     ...
     *
     * <ul>
     *   <li>{@link PresenceUpdateEvent#getCurrent()}
     *   <li>{@link PresenceUpdateEvent#toString()}
     * </ul>
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetCurrent() {
        ...
        //   discord4j.core.event.domain.PresenceUpdateEvent.<init>.
        ...
        PresenceUpdateEvent presenceUpdateEvent = null;

        // Act
        Presence actualCurrent = presenceUpdateEvent.getCurrent();
        String actualToStringResult = presenceUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link PresenceUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        Presence current = new Presence(null);
        (new PresenceUpdateEvent(gateway, shardInfo, 1L, oldUser, null, current, new Presence(null))).getOld();
    }
