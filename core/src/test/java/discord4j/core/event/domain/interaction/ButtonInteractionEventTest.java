...
class ButtonInteractionEventTest {
    /**
     * Method under test: {@link ButtonInteractionEvent#ButtonInteractionEvent(GatewayDiscordClient, ShardInfo, Interaction)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new ButtonInteractionEvent(gateway, shardInfo, new Interaction(new GatewayDiscordClient(null, gatewayResources2,
