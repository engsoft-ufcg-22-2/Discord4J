...
class GuildDeleteEventTest {
    /**
     * Method under test: {@link GuildDeleteEvent#GuildDeleteEvent(GatewayDiscordClient, ShardInfo, long, Guild, boolean)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new GuildDeleteEvent(gateway, shardInfo, 1L, new Guild(new GatewayDiscordClient(null, gatewayResources2, null,
            gatewayClientGroup2, voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null), true);
    ...
    /**
     * Method under test: {@link GuildDeleteEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
    ...
    /**
     * Method under test: {@link GuildDeleteEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
     ...
     *
     * <ul>
     *   <li>{@link GuildDeleteEvent#isUnavailable()}
     *   <li>{@link GuildDeleteEvent#toString()}
     * </ul>
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testIsUnavailable() {
        ...
        //   discord4j.core.event.domain.guild.GuildDeleteEvent.<init>.
        ...
        GuildDeleteEvent guildDeleteEvent = null;

        // Act
        boolean actualIsUnavailableResult = guildDeleteEvent.isUnavailable();
        String actualToStringResult = guildDeleteEvent.toString();
