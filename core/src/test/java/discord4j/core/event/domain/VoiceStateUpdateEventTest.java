...
class VoiceStateUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link VoiceStateUpdateEvent#VoiceStateUpdateEvent(GatewayDiscordClient, ShardInfo, VoiceState, VoiceState)}
     *   <li>{@link VoiceStateUpdateEvent#getCurrent()}
     *   <li>{@link VoiceStateUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.VoiceStateUpdateEvent.<init>.
        ...
        // Act
        VoiceStateUpdateEvent actualVoiceStateUpdateEvent = new VoiceStateUpdateEvent(gateway, shardInfo, current, old);
        VoiceState actualCurrent = actualVoiceStateUpdateEvent.getCurrent();
        String actualToStringResult = actualVoiceStateUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link VoiceStateUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        (new VoiceStateUpdateEvent(gateway, shardInfo, current,
    ...
    /**
     * Method under test: {@link VoiceStateUpdateEvent#isJoinEvent()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testIsJoinEvent() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        (new VoiceStateUpdateEvent(gateway, shardInfo, current,
            new VoiceState(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
                voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null))).isJoinEvent();
    }

    /**
     * Method under test: {@link VoiceStateUpdateEvent#isLeaveEvent()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testIsLeaveEvent() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        (new VoiceStateUpdateEvent(gateway, shardInfo, current,
            new VoiceState(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
                voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null))).isLeaveEvent();
    }

    /**
     * Method under test: {@link VoiceStateUpdateEvent#isMoveEvent()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testIsMoveEvent() {
        ...
        (new VoiceStateUpdateEvent(gateway, shardInfo, current,
            new VoiceState(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
                voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null))).isMoveEvent();
    }
}
