...
class UnbanEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link UnbanEvent#UnbanEvent(GatewayDiscordClient, ShardInfo, User, long)}
     *   <li>{@link UnbanEvent#getUser()}
     *   <li>{@link UnbanEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.guild.UnbanEvent.<init>.
        ...
        // Act
        UnbanEvent actualUnbanEvent = new UnbanEvent(gateway, shardInfo, user, guildId);
        User actualUser = actualUnbanEvent.getUser();
        String actualToStringResult = actualUnbanEvent.toString();
    ...
    /**
     * Method under test: {@link UnbanEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
        ...
        (new UnbanEvent(gateway, shardInfo, new User(new GatewayDiscordClient(null, gatewayResources2, null,
    ...
    /**
     * Method under test: {@link UnbanEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
