...
class MemberLeaveEventTest {
    /**
     * Method under test: {@link MemberLeaveEvent#MemberLeaveEvent(GatewayDiscordClient, ShardInfo, User, long, Member)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        User user = new User(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
        ...
        new MemberLeaveEvent(gateway, shardInfo, user, 1L, new Member(new GatewayDiscordClient(null, gatewayResources3,
            null, gatewayClientGroup3, voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null, 1L));
     ...
     *
     * <ul>
     *   <li>{@link MemberLeaveEvent#getUser()}
     *   <li>{@link MemberLeaveEvent#toString()}
     * </ul>
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetUser() {
        ...
        //   discord4j.core.event.domain.guild.MemberLeaveEvent.<init>.
        ...
        MemberLeaveEvent memberLeaveEvent = null;

        // Act
        User actualUser = memberLeaveEvent.getUser();
        String actualToStringResult = memberLeaveEvent.toString();
    ...
    /**
     * Method under test: {@link MemberLeaveEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
    ...
    /**
     * Method under test: {@link MemberLeaveEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
    ...
    /**
     * Method under test: {@link MemberLeaveEvent#getMember()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetMember() {
