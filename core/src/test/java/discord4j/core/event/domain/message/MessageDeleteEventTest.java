...
class MessageDeleteEventTest {
    /**
     * Method under test: {@link MessageDeleteEvent#MessageDeleteEvent(GatewayDiscordClient, ShardInfo, long, long, Long, Message)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new MessageDeleteEvent(gateway, shardInfo, 1L, 1L, 1L, new Message(new GatewayDiscordClient(null, gatewayResources2,
    ...
    void testConstructor2() {
        ...
        VoiceConnectionFactory voiceConnectionFactory2 = mock(VoiceConnectionFactory.class);
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        new MessageDeleteEvent(gateway, shardInfo, 1L, 1L, 1L,
            new Message(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null));

    }

    /**
     * Method under test: {@link MessageDeleteEvent#getMessageId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    ...
    /**
     * Method under test: {@link MessageDeleteEvent#getMessage()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetMessage() {
    ...
    /**
     * Method under test: {@link MessageDeleteEvent#getChannelId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetChannelId() {
        ...
        (new MessageDeleteEvent(gateway, shardInfo, 1L, 1L, 1L,
            new Message(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null))).getChannelId();
    }
    ...
    /**
     * Method under test: {@link MessageDeleteEvent#getChannel()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetChannel() {
        ...
        (new MessageDeleteEvent(gateway, shardInfo, 1L, 1L, 1L,
            new Message(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null))).getChannel();
    }
    ...
    /**
     * Method under test: {@link MessageDeleteEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
        ...
        (new MessageDeleteEvent(gateway, shardInfo, 1L, 1L, 1L,
            new Message(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null))).getGuildId();
    }
    ...
    /**
     * Method under test: {@link MessageDeleteEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
        ...
        (new MessageDeleteEvent(gateway, shardInfo, 1L, 1L, 1L,
            new Message(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null))).getGuild();
    }
    ...
    /**
     * Method under test: {@link MessageDeleteEvent#toString()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testToString() {
        ...
        //   discord4j.core.event.domain.message.MessageDeleteEvent.<init>.
        ...
        MessageDeleteEvent messageDeleteEvent = null;

        // Act
        String actualToStringResult = messageDeleteEvent.toString();
