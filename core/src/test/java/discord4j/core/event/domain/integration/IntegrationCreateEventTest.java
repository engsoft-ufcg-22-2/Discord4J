...
class IntegrationCreateEventTest {
    /**
     * Method under test: {@link IntegrationCreateEvent#IntegrationCreateEvent(GatewayDiscordClient, ShardInfo, long, Integration)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new IntegrationCreateEvent(gateway, shardInfo, 1L, new Integration(new GatewayDiscordClient(null, gatewayResources2,
    ...
    void testConstructor2() {
        ...
        VoiceConnectionFactory voiceConnectionFactory2 = mock(VoiceConnectionFactory.class);
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        new IntegrationCreateEvent(gateway, shardInfo, 1L,
    ...
    /**
     * Method under test: {@link IntegrationCreateEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
    ...
    /**
     * Method under test: {@link IntegrationCreateEvent#getIntegration()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetIntegration() {
        ...
        //   discord4j.core.event.domain.integration.IntegrationCreateEvent.<init>.
        ...
        IntegrationCreateEvent integrationCreateEvent = null;

        // Act
        Integration actualIntegration = integrationCreateEvent.getIntegration();
