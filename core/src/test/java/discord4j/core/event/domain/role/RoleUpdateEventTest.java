...
class RoleUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link RoleUpdateEvent#RoleUpdateEvent(GatewayDiscordClient, ShardInfo, Role, Role)}
     *   <li>{@link RoleUpdateEvent#getCurrent()}
     *   <li>{@link RoleUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.role.RoleUpdateEvent.<init>.
        ...
        // Act
        RoleUpdateEvent actualRoleUpdateEvent = new RoleUpdateEvent(gateway, shardInfo, current, old);
        Role actualCurrent = actualRoleUpdateEvent.getCurrent();
        String actualToStringResult = actualRoleUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link RoleUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        Role current = new Role(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
        ...
        (new RoleUpdateEvent(gateway, shardInfo, current, new Role(new GatewayDiscordClient(null, gatewayResources3, null,
            gatewayClientGroup3, voiceConnectionFactory3, entityRetrievalStrategy3, new HashSet<>()), null, 1L)))
            .getOld();
    }
