...
class ReactionAddEventTest {
    /**
     * Method under test: {@link ReactionAddEvent#ReactionAddEvent(GatewayDiscordClient, ShardInfo, long, long, long, Long, ReactionEmoji, Member)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2, voiceConnectionFactory2,
                entityRetrievalStrategy2, new HashSet<>()), null, 1L));
    ...
    void testConstructor2() {
        ...
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L));

    }

    /**
     * Method under test: {@link ReactionAddEvent#getUserId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetUserId() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getUserId();
    }
    ...
    /**
     * Method under test: {@link ReactionAddEvent#getUser()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetUser() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getUser();
    }
    ...
    /**
     * Method under test: {@link ReactionAddEvent#getChannelId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetChannelId() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getChannelId();
    }
    ...
    /**
     * Method under test: {@link ReactionAddEvent#getChannel()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetChannel() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getChannel();
    }
    ...
    /**
     * Method under test: {@link ReactionAddEvent#getMessageId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetMessageId() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getMessageId();
    }
    ...
    /**
     * Method under test: {@link ReactionAddEvent#getMessage()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetMessage() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getMessage();
    }
    ...
    /**
     * Method under test: {@link ReactionAddEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getGuildId();
    }
    ...
    /**
     * Method under test: {@link ReactionAddEvent#getGuild()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuild() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getGuild();
    }
     ...
     *
     * <ul>
     *   <li>{@link ReactionAddEvent#getEmoji()}
     *   <li>{@link ReactionAddEvent#toString()}
     * </ul>
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetEmoji() {
        ...
        //   discord4j.core.event.domain.message.ReactionAddEvent.<init>.
        ...
        ReactionAddEvent reactionAddEvent = null;

        // Act
        ReactionEmoji actualEmoji = reactionAddEvent.getEmoji();
        String actualToStringResult = reactionAddEvent.toString();
    ...
    /**
     * Method under test: {@link ReactionAddEvent#getMember()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetMember() {
        ...
        (new ReactionAddEvent(gateway, shardInfo, 1L, 1L, 1L, 1L, emoji,
            new Member(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L))).getMember();
    }
