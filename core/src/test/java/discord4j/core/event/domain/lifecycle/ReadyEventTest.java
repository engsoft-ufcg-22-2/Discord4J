...
class ReadyEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link ReadyEvent#ReadyEvent(GatewayDiscordClient, ShardInfo, Ready, User, Set)}
     *   <li>{@link ReadyEvent#getData()}
     *   <li>{@link ReadyEvent#getGuilds()}
     *   <li>{@link ReadyEvent#getSelf()}
     *   <li>{@link ReadyEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.lifecycle.ReadyEvent.<init>.
        ...
        Ready data = null;
        User self = null;
        Set<ReadyEvent.Guild> guilds = null;

        // Act
        ReadyEvent actualReadyEvent = new ReadyEvent(gateway, shardInfo, data, self, guilds);
        Ready actualData = actualReadyEvent.getData();
        Set<ReadyEvent.Guild> actualGuilds = actualReadyEvent.getGuilds();
        User actualSelf = actualReadyEvent.getSelf();
        String actualToStringResult = actualReadyEvent.toString();
    ...
    /**
     * Method under test: {@link ReadyEvent#getGatewayVersion()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGatewayVersion() {
        // TODO: Complete this test.
        ...
        User self = new User(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
            voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null);

        (new ReadyEvent(gateway, shardInfo, null, self, new HashSet<>())).getGatewayVersion();
    }
    ...
    /**
     * Method under test: {@link ReadyEvent#getSessionId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetSessionId() {
        ...
        (new ReadyEvent(gateway, shardInfo, null, self, new HashSet<>())).getSessionId();
    }
    ...
    /**
     * Method under test: {@link ReadyEvent#getTrace()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetTrace() {
        ...
        (new ReadyEvent(gateway, shardInfo, null, self, new HashSet<>())).getTrace();
    }
     ...
     *
     * <ul>
     *   <li>{@link ReadyEvent.Guild#Guild(long, boolean)}
     *   <li>{@link ReadyEvent.Guild#toString()}
     *   <li>{@link ReadyEvent.Guild#isAvailable()}
     * </ul>
     */
    @Test
    void testGuildConstructor() {
        ReadyEvent.Guild actualGuild = new ReadyEvent.Guild(1L, true);
        String actualToStringResult = actualGuild.toString();
        assertTrue(actualGuild.isAvailable());
        assertEquals("Guild{id=1, available=true}", actualToStringResult);
    }

    /**
     * Method under test: {@link ReadyEvent.Guild#Guild(long, boolean)}
     */
    @Test
    void testGuildConstructor2() {
        assertTrue((new ReadyEvent.Guild(1L, true)).isAvailable());
    }

    /**
     * Method under test: {@link ReadyEvent.Guild#equals(Object)}
     */
    @Test
    void testGuildEquals() {
        assertNotEquals(new ReadyEvent.Guild(1L, true), null);
        assertNotEquals(new ReadyEvent.Guild(1L, true), "Different type to Guild");
    }
     ...
     *
     * <ul>
     *   <li>{@link ReadyEvent.Guild#equals(Object)}
     *   <li>{@link ReadyEvent.Guild#hashCode()}
     * </ul>
     */
    @Test
    void testGuildEquals2() {
        ReadyEvent.Guild guild = new ReadyEvent.Guild(1L, true);
        assertEquals(guild, guild);
        int expectedHashCodeResult = guild.hashCode();
        assertEquals(expectedHashCodeResult, guild.hashCode());
    }
     ...
     */
    @Test
    void testGuildEquals3() {
        ReadyEvent.Guild guild = new ReadyEvent.Guild(1L, true);
        ReadyEvent.Guild guild2 = new ReadyEvent.Guild(1L, true);

        assertEquals(guild, guild2);
        int expectedHashCodeResult = guild.hashCode();
        assertEquals(expectedHashCodeResult, guild2.hashCode());
    }
     ...
     */
    @Test
    void testGuildEquals4() {
        ReadyEvent.Guild guild = new ReadyEvent.Guild(2L, true);
        assertNotEquals(guild, new ReadyEvent.Guild(1L, true));
    }
     ...
     */
    @Test
    void testGuildEquals5() {
        ReadyEvent.Guild guild = new ReadyEvent.Guild(1L, false);
        assertNotEquals(guild, new ReadyEvent.Guild(1L, true));
    }

    /**
     * Method under test: {@link ReadyEvent.Guild#getId()}
     */
    @Test
    void testGuildGetId() {
        // TODO: Complete this test.
        ...
        (new ReadyEvent.Guild(1L, true)).getId();
    }
}
