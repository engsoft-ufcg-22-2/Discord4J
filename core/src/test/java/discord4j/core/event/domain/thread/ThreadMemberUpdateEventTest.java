...
class ThreadMemberUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link ThreadMemberUpdateEvent#ThreadMemberUpdateEvent(GatewayDiscordClient, ShardInfo, ThreadMember, ThreadMember)}
     *   <li>{@link ThreadMemberUpdateEvent#getMember()}
     *   <li>{@link ThreadMemberUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.thread.ThreadMemberUpdateEvent.<init>.
        ...
        ThreadMember old = null;

        // Act
        ThreadMemberUpdateEvent actualThreadMemberUpdateEvent = new ThreadMemberUpdateEvent(gateway, shardInfo, member,
            old);
        ThreadMember actualMember = actualThreadMemberUpdateEvent.getMember();
        String actualToStringResult = actualThreadMemberUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link ThreadMemberUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        ThreadMember member = new ThreadMember(new GatewayDiscordClient(null, gatewayResources2, null,
        ...
        (new ThreadMemberUpdateEvent(gateway, shardInfo, member,
            new ThreadMember(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
