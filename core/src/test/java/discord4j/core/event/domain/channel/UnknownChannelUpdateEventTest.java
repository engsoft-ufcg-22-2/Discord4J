...
class UnknownChannelUpdateEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link UnknownChannelUpdateEvent#UnknownChannelUpdateEvent(GatewayDiscordClient, ShardInfo, UnknownChannel, UnknownChannel)}
     *   <li>{@link UnknownChannelUpdateEvent#getCurrent()}
     *   <li>{@link UnknownChannelUpdateEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.channel.UnknownChannelUpdateEvent.<init>.
        ...
        UnknownChannel current = null;
        UnknownChannel old = null;

        // Act
        UnknownChannelUpdateEvent actualUnknownChannelUpdateEvent = new UnknownChannelUpdateEvent(gateway, shardInfo,
            current, old);
        UnknownChannel actualCurrent = actualUnknownChannelUpdateEvent.getCurrent();
        String actualToStringResult = actualUnknownChannelUpdateEvent.toString();
    ...
    /**
     * Method under test: {@link UnknownChannelUpdateEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        UnknownChannel current = new UnknownChannel(new GatewayDiscordClient(null, gatewayResources2, null,
        ...
        (new UnknownChannelUpdateEvent(gateway, shardInfo, current,
            new UnknownChannel(new GatewayDiscordClient(null, gatewayResources3, null, gatewayClientGroup3,
