...
class ModalSubmitInteractionEventTest {
    /**
     * Method under test: {@link ModalSubmitInteractionEvent#ModalSubmitInteractionEvent(GatewayDiscordClient, ShardInfo, Interaction)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new ModalSubmitInteractionEvent(gateway, shardInfo,
    ...
    /**
     * Method under test: {@link ModalSubmitInteractionEvent#getCustomId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    ...
    /**
     * Method under test: {@link ModalSubmitInteractionEvent#getComponents()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetComponents() {
        ...
        (new ModalSubmitInteractionEvent(gateway, shardInfo,
            new Interaction(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null))).getComponents();
    }
    ...
    /**
     * Method under test: {@link ModalSubmitInteractionEvent#getComponents(Class)}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetComponents3() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        VoiceConnectionFactory voiceConnectionFactory2 = mock(VoiceConnectionFactory.class);
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        ModalSubmitInteractionEvent modalSubmitInteractionEvent = new ModalSubmitInteractionEvent(gateway, shardInfo,
            new Interaction(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null));
        modalSubmitInteractionEvent.getComponents(MessageComponent.class);
    }
    ...
    /**
     * Method under test: {@link ModalSubmitInteractionEvent#presentModal(InteractionPresentModalSpec)}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testPresentModal() {
        ...
        ModalSubmitInteractionEvent modalSubmitInteractionEvent = new ModalSubmitInteractionEvent(gateway, shardInfo,
            new Interaction(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null));
        modalSubmitInteractionEvent.presentModal(InteractionPresentModalSpec.create());
    }
