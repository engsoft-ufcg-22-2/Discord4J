...
class IntegrationUpdateEventTest {
    /**
     * Method under test: {@link IntegrationUpdateEvent#IntegrationUpdateEvent(GatewayDiscordClient, ShardInfo, long, Integration)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new IntegrationUpdateEvent(gateway, shardInfo, 1L, new Integration(new GatewayDiscordClient(null, gatewayResources2,
            null, gatewayClientGroup2, voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L));
    ...
    void testConstructor2() {
        ...
        VoiceConnectionFactory voiceConnectionFactory2 = mock(VoiceConnectionFactory.class);
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        new IntegrationUpdateEvent(gateway, shardInfo, 1L,
            new Integration(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null, 1L));

    }

    /**
     * Method under test: {@link IntegrationUpdateEvent#getGuildId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetGuildId() {
    ...
    /**
     * Method under test: {@link IntegrationUpdateEvent#getIntegration()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetIntegration() {
        ...
        //   discord4j.core.event.domain.integration.IntegrationUpdateEvent.<init>.
        ...
        IntegrationUpdateEvent integrationUpdateEvent = null;

        // Act
        Integration actualIntegration = integrationUpdateEvent.getIntegration();
