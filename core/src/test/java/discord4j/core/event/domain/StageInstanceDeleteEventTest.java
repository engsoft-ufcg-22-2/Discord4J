...
class StageInstanceDeleteEventTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link StageInstanceDeleteEvent#StageInstanceDeleteEvent(GatewayDiscordClient, ShardInfo, StageInstance)}
     *   <li>{@link StageInstanceDeleteEvent#toString()}
     * </ul>
     */
    @Test
    ...
    void testConstructor() {
        ...
        //   discord4j.core.event.domain.StageInstanceDeleteEvent.<init>.
        ...
        // Act
        StageInstanceDeleteEvent actualStageInstanceDeleteEvent = new StageInstanceDeleteEvent(gateway, shardInfo, old);
        String actualToStringResult = actualStageInstanceDeleteEvent.toString();
    ...
    /**
     * Method under test: {@link StageInstanceDeleteEvent#getOld()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetOld() {
        ...
        (new StageInstanceDeleteEvent(gateway, shardInfo,
            new StageInstance(new GatewayDiscordClient(null, gatewayResources2, null, gatewayClientGroup2,
                voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null))).getOld();
    }
