...
class UserInteractionEventTest {
    /**
     * Method under test: {@link UserInteractionEvent#UserInteractionEvent(GatewayDiscordClient, ShardInfo, Interaction)}
     */
    @Test
    ...
    void testConstructor() {
        ...
        new UserInteractionEvent(gateway, shardInfo, new Interaction(new GatewayDiscordClient(null, gatewayResources2, null,
    ...
    void testConstructor2() {
        ...
        VoiceConnectionFactory voiceConnectionFactory2 = mock(VoiceConnectionFactory.class);
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        new UserInteractionEvent(gateway, shardInfo, new Interaction(new GatewayDiscordClient(null, gatewayResources2,
            null, gatewayClientGroup2, voiceConnectionFactory2, entityRetrievalStrategy2, new HashSet<>()), null));

    }

    /**
     * Method under test: {@link UserInteractionEvent#getResolvedUser()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetResolvedUser() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
    ...
    /**
     * Method under test: {@link UserInteractionEvent#getTargetId()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    ...
    /**
     * Method under test: {@link UserInteractionEvent#getTargetUser()}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetTargetUser() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
    ...
    /**
     * Method under test: {@link UserInteractionEvent#getTargetUser(EntityRetrievalStrategy)}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetTargetUser3() {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        VoiceConnectionFactory voiceConnectionFactory2 = mock(VoiceConnectionFactory.class);
        EntityRetrievalStrategy entityRetrievalStrategy2 = mock(EntityRetrievalStrategy.class);
        (new UserInteractionEvent(gateway, shardInfo,
            ...
            .getTargetUser(mock(EntityRetrievalStrategy.class));
    }
